...
type PositionCastlingTests(magicGenerationSetupFixture:MagicGenerationSetupFixture) =
    ...
    [<InlineDataEx("rn1qkbnr/ppp2ppp/3p4/4p3/4P1b1/8/PPP2PPP/R3KBNR w KQkq - 0 1", "e1c1", "white queenside, path under check (1)")>]
    [<InlineDataEx("rn1qkbnr/ppp2ppp/8/3ppb2/8/2P5/PP3PPP/R3KBNR w KQkq - 0 1", "e1c1", "white queenside, path under check (2)")>]
    ...
    [<InlineDataEx("r3kbnr/ppp2ppp/8/3p2B1/3P4/8/PPP1PPPP/RN1QKBNR b KQkq - 0 1", "e8c8", "black queenside, path under check (1)")>]
    [<InlineDataEx("r3kbnr/pp3ppp/2p5/3p4/3P1B2/8/PPP1PPPP/RN1QKBNR b KQkq - 0 1", "e8c8", "black queenside, path under check (2)")>]
